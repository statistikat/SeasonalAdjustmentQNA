...
vert_D11 <- perHts(
  ...
  vert_BTE = perTramo(T103TS[, "D11_XDC_W2_BTE"], template = "RSA3", 
                       ...
                       outlier.enabled = FALSE, 
                       usrdef.outliersEnabled = TRUE, 
                       usrdef.outliersType = c("AO", "LS", "LS", "AO", "AO", "AO", "AO", "AO"),
  ...
  vert_L = perTramo(T103TS[, "D11_XDC_W2_L"], template = "RSA3", 
                     ...
                     outlier.enabled = FALSE, 
                     usrdef.outliersEnabled = TRUE, 
                     usrdef.outliersType = c("AO", "AO", "AO", "TC", "AO", "AO", "AO"),
  ...
  vert_M_N = perTramo(T103TS[, "D11_XDC_W2_M_N"], template = "RSA3", 
                      ...
                      outlier.enabled = FALSE, 
                      usrdef.outliersEnabled = TRUE, 
                      usrdef.outliersType = c("LS","TC", "TC", "AO", "AO", "AO", "AO", "AO", "AO", "AO"),
  ...
  vert_RTU = perTramo(T103TS[, "D11_XDC_W2_RTU"], template = "RSA3", 
                       ...
                       usrdef.outliersDate = c("2007-10-01", "2020-01-01", "2020-04-01",
                                               "2020-07-01", "2020-10-01", "2021-01-01",
                                               "2021-04-01"),
                       # Trading Days ---------------------------------------------------------
                       # usrdef.varEnabled = FALSE, 
