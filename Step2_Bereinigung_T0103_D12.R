...
vert_D12 <- perHts(
  ...
  vert_C = perTramo(T103TS[, "D12_XDC_W2_C"], template = "RSA3",
                     ...
                     usrdef.outliersDate = c("2002-01-01", "2020-01-01", "2020-04-01","2020-07-01", "2020-10-01", "2021-01-01"),
                     # Trading Days ---------------------------------------------------------
                     # usrdef.varEnabled = FALSE, 
                     # usrdef.var = NA, usrdef.varType = "Calendar", 
                     # tradingdays.option = "UserDefined",
  ...
  vert_GTI = perTramo(T103TS[, "D12_XDC_W2_GTI"] , template = "RSA3",
                       ...
                       outlier.enabled = FALSE, 
                       usrdef.outliersEnabled = TRUE, 
                       usrdef.outliersType = c("TC","TC", "AO","AO","AO","AO", "AO"),
  ...
  vert_L = perTramo(T103TS[, "D12_XDC_W2_L"], template = "RSA3", 
                     ...
                     outlier.enabled = FALSE, 
                     usrdef.outliersEnabled = TRUE, 
                     usrdef.outliersType = c("AO", "TC", "AO","AO", "AO", "AO","AO", "AO", "AO"),
