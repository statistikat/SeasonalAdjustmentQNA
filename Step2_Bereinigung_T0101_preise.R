...
ent_price <- perHts(
  ...
  ent_A = perTramo(T101TS$impPI_L[, "A"], template = "RSA3", 
                    ...
                    usrdef.outliersDate = c("2001-04-01", "2020-04-01", "2020-07-01", "2020-10-01", "2021-01-01", "2021-04-01"),
                    # Trading Days ---------------------------------------------------------
  ...
  ent_J = perTramo(T101TS$impPI_L[, "J"], template = "RSA3", 
                    ...
                    outlier.enabled = FALSE, 
                    usrdef.outliersEnabled = TRUE, 
                    usrdef.outliersType = c("LS", "AO", "AO", "AO", "AO", "AO", "AO", "AO", "AO"),
                    usrdef.outliersDate = c("1996-01-01", "2012-07-01", "2013-07-01",
                                            "2015-07-01", "2020-04-01", "2020-07-01", "2020-10-01", "2021-01-01", "2021-04-01"),
                    # Trading Days ---------------------------------------------------------
                    # usrdef.varEnabled = FALSE, 
                    # usrdef.var = NA, usrdef.varType = "Calendar", 
                    # tradingdays.option = "UserDefined",
  ...
  ent_RTU = perTramo(T101TS$impPI_L[, "RTU"], template = "RSA3", 
                      ...
                      usrdef.outliersDate = c("2020-04-01", "2020-07-01", "2020-10-01", "2021-01-01", "2021-04-01"),
                      # Trading Days ---------------------------------------------------------
                      # usrdef.varEnabled = FALSE, 
                      # usrdef.var = NA, usrdef.varType = "Calendar", 
                      # tradingdays.option = "UserDefined",
